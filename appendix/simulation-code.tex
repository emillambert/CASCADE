\section{Python Simulation Code Excerpts}
\label{appendix:code}
...
\begin{itemize}
  \item Downlink reduction vs raw: \textbf{97.8\,\%}
  \item Energy saving vs raw: \textbf{22.0\,\%}
  \item Science retention: \textbf{100\,\%}
  \item False-positive rate: \textbf{1.0\,\%} with cloud and benign-stress confounders
  \item Peak / duty-cycled average payload power: \textbf{9.6\,W} / \textbf{5.05\,W}
  \item Minimum battery SOC: \textbf{86\,\%} in a local \textbf{40\,Wh} battery buffer
\end{itemize}
...
def compute_csc(evi_t, lst_t, evi_base, lst_base):
    ...
    # 5σ (EVI) and 4σ (LST) normalize anomaly magnitudes to [0, 1]

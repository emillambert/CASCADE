\chapter{Expected Next Steps}
\label{chapter:next-steps}

%% ---------------------------------------------------------------
\section{Development Process: Concept to MVP}
\label{sec:concept-to-mvp}
%% ---------------------------------------------------------------

\textbf{Current state --- TRL~3.}
The Python simulation (Appendix~\ref{appendix:code}) validates the two-stage MDP scheduling logic and CSC fusion computation on synthetic MODIS proxy data. All SWAP budgets are confirmed with positive margin. Market gap identified: no sub-day adaptive pathogen alert product at $<$\$5/ha/year currently exists.
...
%% ---------------------------------------------------------------
\section{Next Steps if Selected as Finalist}
